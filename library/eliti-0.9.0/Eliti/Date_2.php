...
class Eliti_Date_2 {
    ...
    public static function isValid($date, $format = self::SQL) {
    ...
    private function __construct($date, $format = self::SQL) {
    ...
    public static function create($date = null, $format = self::SQL) {
    ...
    public function format($format = self::SQL) {
